-- Script to fix migration history and create MaintenanceTasks table
-- Run this in SQL Server Management Studio or Azure Data Studio

-- Step 1: Mark InitialCreate migration as applied (if not already)
IF NOT EXISTS (SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = '20260123090222_InitialCreate')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES ('20260123090222_InitialCreate', '8.0.0');
END

-- Step 2: Create MaintenanceTasks table if it doesn't exist
...
-- Step 3: Mark AddMaintenanceTask migration as applied
